...
public class Tugba {
    ...
    */
    ...
    public static void printNumbers(int N) {
        ...
        for (int i = 1; i <= N; i++) {
            System.out.println( (i%2==0 && i%3==0 && i%5==0) ?  "CodilityTestCoders" : (i%2==0 && i%3==0) ? "CodilityTest" :(i%3==0 && i%5==0) ? "TestCoders"
                    :(i%2==0 && i%5==0)? "CodilityCoders" : (i%5==0) ? "Coders" : (i%2==0) ? "Codility" :(i%3==0) ? "Test" : i );
